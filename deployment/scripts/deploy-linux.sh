#!/bin/bash
# Car Log MCP Servers - Linux Deployment Script
# This script deploys MCP servers to a folder outside the git repository
# for use with Claude Desktop on Linux

set -e  # Exit on error

echo "========================================"
echo "  Car Log MCP Servers - Linux Deploy"
echo "========================================"
echo ""
...
echo "   ./deployment/scripts/merge-config-linux.sh"
echo ""
